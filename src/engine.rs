...
pub fn run_engine(input_index_data: &[[i8; 5]], correction_data: &[bool], weights: &mut[[f32; 5]], generations: i32) {
...
fn network(input_index_data: &[[i8; 5]], weights: &mut[[f32; 5]], correction_data: &[bool], input_index: usize) -> [f32; 2] {
